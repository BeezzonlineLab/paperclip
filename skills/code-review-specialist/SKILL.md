...
description: >
  Use this agent when you need expert code review immediately after writing or
  modifying code. This agent proactively analyzes code for quality issues,
  security vulnerabilities, performance concerns, and maintainability problems.
  Trigger this agent automatically after completing any code implementation,
  refactoring, or bug fix to ensure high code quality before proceeding.
license: MIT
...
| Spec Compliance | `references/spec-compliance-review.md` | Reviewing implementations, PR review |
